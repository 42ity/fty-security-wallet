...
Snmpv3::Snmpv3(const std::string& name, Snmpv3SecurityLevel securityLevel, const std::string& securityName,
    Snmpv3AuthProtocol authProtocol, const std::string& authPassword, Snmpv3PrivProtocol privProtocol,
