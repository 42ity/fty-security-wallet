...
static test_item_t
all_tests [] = {
    { "fty_credential_asset_mapping_mlm_agent", fty_credential_asset_mapping_mlm_agent_test },
    { "fty_security_wallet_socket_agent", fty_security_wallet_socket_agent_test },
    {NULL, NULL}          //  Sentinel
};
...
{
    printf ("Running fty-security-wallet selftests...\n");
    test_item_t *item;
