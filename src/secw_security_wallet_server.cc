...
secw_security_wallet_server_test (bool verbose)
{
    ...
    // need to be activated when fty-commom will be deploy std::vector<std::pair<std::string,bool>> testLibProducerResults = secw_producer_accessor_test(syncClient, testStream);
    std::vector<std::pair<std::string,bool>> testLibProducerResults;
