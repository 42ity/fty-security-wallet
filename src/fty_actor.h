...
#ifndef FTY_ACTOR_H_INCLUDED
#define FTY_ACTOR_H_INCLUDED
...
protected:
     ...
     */
    FtyActor(zsock_t *pipe, const char *endpoint = NULL, const char *address = NULL, int pollerTimeout = -1, int connectionTimeout = 5000);
    /**
