...
namespace secw
{
    ...
    std::vector<std::string> ClientAccessor::getPortfolioList() const
    {
        ...
        if(frames.size() < 1)
        {
            throw SecwProtocolErrorException("Empty answer from agent");
        }
    ...
    std::vector<DocumentPtr> ClientAccessor::getDocumentsWithPrivateData(
        ...
        const DocumentPtr & doc) const
    {
        ...
        si <<= doc;
        std::string jsonDoc = seralize(si);
...
//Private
    ...
    std::string ClientAccessor::seralize(const cxxtools::SerializationInfo & si)
    {
...
//test 1 => getPortfolioList
    printf("\n-----------------------------------------------------------------------\n");
    {
        ...
        try
        {
            ...
            log_debug(" *<= secw_client_accessor_test > Test #1 > OK");
            
            testsResults.emplace_back ("secw_client_accessor_test > Test #1 getPortfolioList",true);
        }
        catch(const std::exception& e)
        {
            ...
            testsResults.emplace_back ("secw_client_accessor_test > Test #1 getPortfolioList",false);
        }
...
//test 2 => getPrivateReadableTagList
    printf("\n-----------------------------------------------------------------------\n");
    {
        ...
        try
        {
            ...
            log_debug(" *<= secw_client_accessor_test > Test #2 > OK");
            testsResults.emplace_back ("secw_client_accessor_test > Test #2 getPrivateReadableTagList",true);

        }
        catch(const std::exception& e)
        {
            log_debug(" *<= secw_client_accessor_test > Test #2 > Failed");
            log_debug("Error: %s\n\n",e.what());
            testsResults.emplace_back ("secw_client_accessor_test > Test #2 getPrivateReadableTagList",false);
        }
    }
...
//test 3 => getEditableTagList
    printf("\n-----------------------------------------------------------------------\n");
    {
        ...
        try
        {
            ...
            log_debug(" *<= secw_client_accessor_test > Test #3 > OK");
            testsResults.emplace_back ("secw_client_accessor_test > Test #3 getEditableTagList",true);

        }
        catch(const std::exception& e)
        {
            log_debug(" *<= secw_client_accessor_test > Test #3 > Failed");
            log_debug("Error: %s\n\n",e.what());
            testsResults.emplace_back ("secw_client_accessor_test > Test #3 getEditableTagList",false);
        }
    }
...
//test 4.1 => getDocumentsWithPrivateData
    printf("\n-----------------------------------------------------------------------\n");
    {
        ...
        try
        {
            std::vector<DocumentPtr> doc = clientAccessor.getDocumentsWithPrivateData("default");
            ...
            log_debug(" *<= secw_client_accessor_test > Test #4.1 > OK");
            testsResults.emplace_back ("secw_client_accessor_test > Test #4.1 getDocumentsWithPrivateData",true);

        }
        catch(const std::exception& e)
        {
            log_debug(" *<= secw_client_accessor_test > Test #4.1 > Failed");
            log_debug("Error: %s\n\n",e.what());
            testsResults.emplace_back ("secw_client_accessor_test > Test #4.1 getDocumentsWithPrivateData",false);
        }
    }
...
//test 4.2 => getDocumentsWithPrivateData tag=test_read
    printf("\n-----------------------------------------------------------------------\n");
    {
        ...
        try
        {
            std::vector<DocumentPtr> doc = clientAccessor.getDocumentsWithPrivateData("default", "test_read");
            ...
            log_debug(" *<= secw_client_accessor_test > Test #4.2 > OK");
            testsResults.emplace_back ("secw_client_accessor_test > Test #4.2 getDocumentsWithPrivateData tag=test_read",true);

        }
        catch(const std::exception& e)
        {
            log_debug(" *<= secw_client_accessor_test > Test #4.2 > Failed");
            log_debug("Error: %s\n\n",e.what());
            testsResults.emplace_back ("secw_client_accessor_test > Test #4.2 getDocumentsWithPrivateData tag=test_read",false);
        }
    }
...
//test 4.3  => getDocumentsWithPrivateData SecwIllegalAccess
    printf("\n-----------------------------------------------------------------------\n");
    {
        ...
        try
        {
            clientAccessor.getDocumentsWithPrivateData("default", "test_update");

            throw std::runtime_error("Documents are returned");
        }
        catch(const SecwIllegalAccess &)
        {
            log_debug(" *<= secw_client_accessor_test > Test #4.3 > OK");
            testsResults.emplace_back ("secw_client_accessor_test > Test #4.3 getDocumentsWithPrivateData => SecwIllegalAccess",true);
        }
        catch(const std::exception& e)
        {
            log_debug(" *<= secw_client_accessor_test > Test #4.3 > Failed");
            log_debug("Error: %s\n\n",e.what());
            testsResults.emplace_back ("secw_client_accessor_test > Test #4.3 getDocumentsWithPrivateData => SecwIllegalAccess",false);
        }
    }
...
//test 5.1 => getDocumentsWithoutPrivateData
    printf("\n-----------------------------------------------------------------------\n");
    {
        ...
        try
        {
            ...
            log_debug(" *<= secw_client_accessor_test > Test #5.1 > OK");
            testsResults.emplace_back ("secw_client_accessor_test > Test #5.1 getDocumentsWithoutPrivateData",true);

        }
        catch(const std::exception& e)
        {
            log_debug(" *<= secw_client_accessor_test > Test #5.1 > Failed");
            log_debug("Error: %s\n\n",e.what());
            testsResults.emplace_back ("secw_client_accessor_test > Test #5.1 getDocumentsWithoutPrivateData",false);
        }
    }
...
//test 5.2 => getDocumentsWithoutPrivateData => SecwUnknownTagException
    printf("\n-----------------------------------------------------------------------\n");
    {
        ...
        {
            log_debug(" *<= secw_client_accessor_test > Test #5.2 > OK");
            testsResults.emplace_back ("secw_client_accessor_test > Test #5.2 getDocumentsWithoutPrivateData => SecwUnknownTagException",true);
        }
        catch(const std::exception& e)
        {
            log_debug(" *<= secw_client_accessor_test > Test #5.2 > Failed");
            log_debug("Error: %s\n\n",e.what());
            testsResults.emplace_back ("secw_client_accessor_test > Test #5.2 getDocumentsWithoutPrivateData => SecwUnknownTagException",false);
        }
    }
...
//test 6 => getDocumentWithPrivateData
    printf("\n-----------------------------------------------------------------------\n");
    {
        ...
        try
        {
            ...
            log_debug(" *<= secw_client_accessor_test > Test #6 > OK");
            testsResults.emplace_back ("secw_client_accessor_test > Test #6 getDocumentWithPrivateData",true);

        }
        catch(const std::exception& e)
        {
            log_debug(" *<= secw_client_accessor_test > Test #6 > Failed");
            log_debug("Error: %s\n\n",e.what());
            testsResults.emplace_back ("secw_client_accessor_test > Test #6 getDocumentWithPrivateData",false);
        }
    }
...
//test 7 => getDocumentWithoutPrivateData
    printf("\n-----------------------------------------------------------------------\n");
    {
        ...
        try
        {
            ...
            log_debug(" *<= secw_client_accessor_test > Test #7 > OK");
            testsResults.emplace_back ("secw_client_accessor_test > Test #7 getDocumentWithoutPrivateData",true);

        }
        catch(const std::exception& e)
        {
            log_debug(" *<= secw_client_accessor_test > Test #7 > Failed");
            log_debug("Error: %s\n\n",e.what());
            testsResults.emplace_back ("secw_client_accessor_test > Test #7 getDocumentWithoutPrivateData",false);
        }
    }
...
//test 8 => SecwDocumentDoNotExistException 1/2
    printf("\n-----------------------------------------------------------------------\n");
    {
        ...
        {
            log_debug(" *<= secw_client_accessor_test > Test #8 > OK");
            testsResults.emplace_back ("secw_client_accessor_test > Test #8 SecwDocumentDoNotExistException 1/2",true);
        }
        catch(const std::exception& e)
        {
            log_debug(" *<= secw_client_accessor_test > Test #8 > Failed");
            log_debug("Error: %s\n\n",e.what());
            testsResults.emplace_back ("secw_client_accessor_test > Test #8 SecwDocumentDoNotExistException 1/2",false);
        }
    }
...
//test 9 => SecwDocumentDoNotExistException 2/2
    printf("\n-----------------------------------------------------------------------\n");
    {
        ...
        {
            log_debug(" *<= secw_client_accessor_test > Test #9 > OK");
            testsResults.emplace_back ("secw_client_accessor_test > Test #9 SecwDocumentDoNotExistException 2/2",true);
        }
        catch(const std::exception& e)
        {
            log_debug(" *<= secw_client_accessor_test > Test #9 > Failed");
            log_debug("Error: %s\n\n",e.what());
            testsResults.emplace_back ("secw_client_accessor_test > Test #9 SecwDocumentDoNotExistException 2/2",false);
        }
    }
...
//test 10  => SecwUnknownPortfolioException
    printf("\n-----------------------------------------------------------------------\n");
    {
        ...
        {
            log_debug(" *<= secw_client_accessor_test > Test #10 > OK");
            testsResults.emplace_back ("secw_client_accessor_test > Test #10 SecwUnknownPortfolioException",true);
        }
        catch(const std::exception& e)
        {
            log_debug(" *<= secw_client_accessor_test > Test #10 > Failed");
            log_debug("Error: %s\n\n",e.what());
            testsResults.emplace_back ("secw_client_accessor_test > Test #10 SecwUnknownPortfolioException",false);
        }
    }
