...
{
    printf ("\n\n ** cam_credential_asset_mapping_server: \n\n");
    ...
    //create the server
    cam::CredentialAssetMappingServer server(std::string(SELFTEST_DIR_RO"/mapping.json"));
    
    //Create a test client
    fty::SyncClientTest syncClient( "cam-server-test", server);
